...
from blog.views import index, list_categories, detail_category, detail_post, create_category_form, create_category, \
    ...
    update_profile_form, ProfileDetailView
...
urlpatterns = [
    ...
    path("post/update/<int:pk>", PostUpdateView.as_view(), name="update_post_view"),
    path("post/delete/<int:pk>", PostDeleteView.as_view(), name="delete_post_view"),
    ...
    path("user/profile/<int:pk>", ProfileDetailView.as_view(), name="detail_profile"),
]
